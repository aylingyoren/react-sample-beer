    ...
    return (
        <div className="beer-details">
           ...
           <>
            ...
            <button onClick={(event: React.MouseEvent<HTMLElement>) => isFav ? removeFromFavorite(beer.id) : addToFavorite(beer)} className="beerP-fav-btn">
                {favorite.includes(beer) ? "Remove from Favorite" : "Add to Favorite"}
            </button>
            ...
            <div className="beerP-propFoodP">
                <div className="beerP-prop">
                    ...
                    <ul className="beerP-properties">
                        <li className="beerP-properties-row">ABV <span className="beerP-properties-value">{beer.abv}</span></li>
                        <li className="beerP-properties-row">IBU <span className="beerP-properties-value">{beer.ibu}</span></li>
                        <li className="beerP-properties-row">EBC <span className="beerP-properties-value">{beer.ebc}</span></li>
                    </ul>
                </div>
                <div className="beerP-foodP">
                    ...
                    <ul className="beerP-foods">
                        {beer.food_pairing.map((foodPairing, index) =>
                            <li key={index} className="beerP-foods-value">{foodPairing}</li>
                        )}
                    </ul>
                </div>
            </div>
            ...
            <div className="beerP-ingredMeth">
                ...
                <Link to='/'> <button className="beerP-back-btn">Back</button> </Link>
            </> : null}
        </div>
    );
}
